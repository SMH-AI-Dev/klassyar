...
import { Plus, Trash2, Save, ArrowRight, Plane } from "lucide-react";
    ...
    <div className="min-h-screen p-4 md:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              ...
              <p className="text-sm md:text-base text-gray-600">به سمت هدف پرواز کن</p>
            </div>
          </div>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Input value={activity.title} onChange={(e) => setActivity({ ...activity, title: e.target.value })}
                placeholder="مثال: سفر هوایی" className="rounded-xl clay-element" />
            </div>
            <div>
              <Label>توضیحات</Label>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <Input value={q.question} onChange={(e) => updateQuestion(qIndex, 'question', e.target.value)}
                      placeholder="سوال خود را بنویسید..." className="rounded-xl clay-element" />
                  </div>
        ...
        <Button onClick={addQuestion} variant="outline"
          className="w-full mt-6 h-16 rounded-2xl clay-element border-2 border-dashed border-blue-300 hover:bg-blue-50">
