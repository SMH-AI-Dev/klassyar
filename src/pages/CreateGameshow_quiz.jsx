...
import { Plus, Trash2, Save, ArrowRight, Trophy } from "lucide-react";
import { motion } from "framer-motion";

export default function CreateGameshow_quiz() {
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-800">مسابقه تلویزیونی 🎬</h1>
              <p className="text-sm md:text-base text-gray-600">آزمون به سبک برنامه‌های مسابقه</p>
            </div>
          </div>
          <Button
            onClick={handleSave}
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="مثال: مسابقه دانستنی‌های علوم"
                className="rounded-xl clay-element"
              />
            </div>
            <div>
              ...
              <Card className="clay-element bg-gradient-to-br from-orange-50 to-red-50 border-0">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <Label>گزینه‌ها (یکی را به عنوان پاسخ صحیح انتخاب کنید)</Label>
                    {q.options.map((option, oIndex) => (
                      <div key={oIndex} className="flex gap-3">
                        ...
                        <Input
                          ...
                          className={`rounded-xl clay-element ${q.correctAnswer === oIndex ? 'bg-green-100 border-green-300' : ''}`}
                        />
                      </div>
                    ))}
                  </div>
