...
export default function CreateScramble() {
  ...
  const save = () => {
    const valid = questions.filter(q => q.hint && q.answer);
    const data = {
      title: "حروف بهم ریخته",
      description: "مرتب کردن حروف برای ساخت کلمه",
      type: "scramble",
    ...
    <div className="min-h-screen p-4 bg-gradient-to-br from-lime-50 to-green-50">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex gap-3 mt-6">
          ...
          <Button onClick={save} className="flex-1 h-12 bg-gradient-to-r from-lime-500 to-green-500 text-white rounded-2xl clay-element">
